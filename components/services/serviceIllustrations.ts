...
export const SERVICE_ILLUSTRATIONS: Record<string, string> = {
  ...
  [SERVICE_ANCHORS.creationSiteEcommerce]: "/assets/illustrations/services-sites-web.png",
  [SERVICE_ANCHORS.digitalisationProcessusEntreprise]: "/assets/illustrations/services-applications-web.png",
};
